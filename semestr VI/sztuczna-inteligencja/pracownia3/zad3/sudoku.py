...
def squared():
    ...
    for i in range(0, 9, 3):
        for j in range(0, 9, 3):
            distincts.append(all_different(get_square(i, j)))
    return distincts
...
def sudoku(assigments):
    ...
    cs = domains(variables) + vertical() + horizontal() + squared()  # TODO: too weak contraints, add something!
