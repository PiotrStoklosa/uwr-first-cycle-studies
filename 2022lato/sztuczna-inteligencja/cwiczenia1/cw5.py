...
def is_straight(deck):
    for i in range(4):
        if rank(deck[i]) + 1 != rank(deck[i + 1]):
            return False
    return True
...
def testPropability():
    blotkarz_counter = 0
    figurant_counter = 0
    blotkarz = getAllPossibleDecks([i for i in range(1, 37)])
    figurant = getAllPossibleDecks([i for i in range(37, 53)])
    result_figurant = [0] * 10
    result_blotkarz = [0] * 10
    for i in figurant:
        result_figurant[hand_rank(i)] += 1
        figurant_counter += 1

    for b in blotkarz:
        result_blotkarz[hand_rank(b)] += 1
        blotkarz_counter += 1

    blotkarz_wins = 0
    blotkarz_wins += result_blotkarz[9] * (
            result_figurant[8] + result_figurant[7] + result_figurant[6] + result_figurant[5] + result_figurant[4] +
            result_figurant[3] +
            result_figurant[2] + result_figurant[1])
    blotkarz_wins += result_blotkarz[8] * (
            result_figurant[7] + result_figurant[6] + result_figurant[5] + result_figurant[4] +
            result_figurant[3] +
            result_figurant[2] + result_figurant[1])
    blotkarz_wins += result_blotkarz[7] * (
            result_figurant[6] + result_figurant[5] + result_figurant[4] +
            result_figurant[3] +
            result_figurant[2] + result_figurant[1])
    blotkarz_wins += result_blotkarz[6] * (
            result_figurant[5] + result_figurant[4] +
            result_figurant[3] +
            result_figurant[2] + result_figurant[1])
    blotkarz_wins += result_blotkarz[5] * (
            result_figurant[4] +
            result_figurant[3] +
            result_figurant[2] + result_figurant[1])
    blotkarz_wins += result_blotkarz[4] * (
            result_figurant[3] +
            result_figurant[2] + result_figurant[1])
    blotkarz_wins += result_blotkarz[3] * (
            result_figurant[2] + result_figurant[1])
    blotkarz_wins += result_blotkarz[2] * (
        result_figurant[1])

    print(blotkarz_wins / (figurant_counter * blotkarz_counter))
